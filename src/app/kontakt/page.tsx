...
export async function generateMetadata(): Promise<Metadata> {
  return localizedPageMetadata({
    titleNb: "Kontakt oss",
    titleEn: "Contact us",
    descNb: "Ta kontakt med TECNOX — kontorer i Oslo, Bergen og Trondheim. Telefon 922 22 800, post@tecnox.no.",
    descEn: "Contact TECNOX — offices in Oslo, Bergen and Trondheim. Phone 922 22 800, post@tecnox.no.",
    ogTitleNb: "Kontakt TECNOX",
    ogTitleEn: "Contact TECNOX",
